...
// Validate checks the field values on UpdateRefreshTokenRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateRefreshTokenRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateRefreshTokenRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateRefreshTokenRequestMultiError, or nil if none found.
func (m *UpdateRefreshTokenRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateRefreshTokenRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for OldToken

	if len(errors) > 0 {
		return UpdateRefreshTokenRequestMultiError(errors)
	}

	return nil
}

// UpdateRefreshTokenRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateRefreshTokenRequest.ValidateAll() if the
// designated constraints aren't met.
type UpdateRefreshTokenRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateRefreshTokenRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateRefreshTokenRequestMultiError) AllErrors() []error { return m }

// UpdateRefreshTokenRequestValidationError is the validation error returned by
// UpdateRefreshTokenRequest.Validate if the designated constraints aren't met.
type UpdateRefreshTokenRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateRefreshTokenRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateRefreshTokenRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateRefreshTokenRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateRefreshTokenRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateRefreshTokenRequestValidationError) ErrorName() string {
	return "UpdateRefreshTokenRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateRefreshTokenRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateRefreshTokenRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateRefreshTokenRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateRefreshTokenRequestValidationError{}

// Validate checks the field values on UpdateRefreshTokenResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateRefreshTokenResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateRefreshTokenResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateRefreshTokenResponseMultiError, or nil if none found.
func (m *UpdateRefreshTokenResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateRefreshTokenResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateRefreshTokenResponseMultiError(errors)
	}

	return nil
}

// UpdateRefreshTokenResponseMultiError is an error wrapping multiple
// validation errors returned by UpdateRefreshTokenResponse.ValidateAll() if
// the designated constraints aren't met.
type UpdateRefreshTokenResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateRefreshTokenResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateRefreshTokenResponseMultiError) AllErrors() []error { return m }

// UpdateRefreshTokenResponseValidationError is the validation error returned
// by UpdateRefreshTokenResponse.Validate if the designated constraints aren't met.
type UpdateRefreshTokenResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateRefreshTokenResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateRefreshTokenResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateRefreshTokenResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateRefreshTokenResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateRefreshTokenResponseValidationError) ErrorName() string {
	return "UpdateRefreshTokenResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateRefreshTokenResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateRefreshTokenResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateRefreshTokenResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateRefreshTokenResponseValidationError{}
